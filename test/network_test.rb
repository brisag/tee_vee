...
class NetworkTest < Minitest::Test
  ...
  def test_it_can_pull_main_characters
    nbc = Network.new("NBC")
  ...
  def test_it_can_add_more_and_actors
    ...
    expected = {
                ...
                "William Daniels" => [knight_rider], "Amy Poehler" => [parks_and_rec], "Nick Offerman" => [parks_and_rec]
              }
